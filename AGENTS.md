...
```bash
npm run sync   # = sync-mcp（MCP）+ sync-sources（第三方 skills / agents / prompts / commands / plugins）
```
...
| 场景 | 入口 |
| --- | --- |
| 添加第三方资源（skills / agents / prompts / commands / plugins） | `.agents/skills/add-external-skill/SKILL.md` |
